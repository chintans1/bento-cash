...
const sampleAccounts = [
  { id: '1', name: 'Checking Account', bank: 'Chase', balance: 6540.92, type: 'Credit', lastUpdated: '2024-06-08' },
  { id: '2', name: 'Savings Account', bank: 'Bank of America', balance: 7670.05, type: 'Depository', lastUpdated: '2024-06-08' },
  { id: '3', name: 'Investment Account', bank: 'Robinhood', balance: 8076.00, type: 'Investment', lastUpdated: '2024-06-08' },
];
    ...
    <View style={styles.accountCard}>
      <View style={styles.accountInfo}>
        ...
        <View style={styles.accountDetailsRight}>
          ...
          <Text style={styles.accountLastUpdated}>Updated: {item.lastUpdated}</Text>
        </View>
      </View>
